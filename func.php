...
if(isset($_POST['patsub'])){
    ...
    echo("<script>alert('Invalid Username or Password. Try Again!');
          window.location.href = 'index1';</script>");
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Techbase Hospital</a>
 ...
 <div class="jumbotron" id="ab1"></div>
  ...
  <div class="col-md-4">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="patientdetails" role="tab" aria-controls="home">Patient List</a>
